...
You can try SSDT hotpatch method, you need [SSDT-EC](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/Source/SSDT-EC.dsl) or [SSDT-EC-USBX](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/Source/SSDT-EC-USBX.dsl) with [SSDT-I2C-XOSI](./Documentation/SSDT-I2C-XOSI.dsl), many i2c devices activate using this method.
